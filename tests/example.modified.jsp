...
<body>
<div id="wrapper" class="orange-rose-halibut">
...
<c:import url="Video_51_header.jsp">
	...
	<div id="content" class="testing testing123 frightened-salmon-lizard">
	...
	<table class="orange-rose-halibut">
		<tr><th>id</th><th>name</th><th>extension</th></tr>
		<c:forEach var="row" items="${rabbit.rows }">	
			<tr>
			<th class="breakable-magenta-wasp">record ${row.id }</th><td>${row.imageName }</td><td>${row.image_extension }</td>
			</tr>	
		</c:forEach>	
	</table>	
